...
T.en = {
  ...
  elite_suffix    = "Elite",
  boss_suffix     = "Lord",
  boss_toi        = "%s has arrived.",
  boss_cuong      = "The boss is ENRAGED!",
  boss_trieu      = "The boss calls its servants.",
  boss_khien      = "The boss raises a barrier.",
  panel_vang      = "Gold",
  panel_go        = "Lumber",
  panel_shop      = "Shop",
  ...
  tb_chua_luyen   = "Not yet forged.",
  tb_len          = "Raise to %s -- %d%%",
  tb_can_tien     = "Perfect. Ascend to continue.",
  tb_tran         = "Cultivation has not reached %s.",
  tb_max          = "Fully evolved.",
  tb_nut_nang     = "FORGE",
  tb_nut_tien     = "ASCEND",
  tb_thanh        = "%s forged %s.",
  tb_truot        = "Forging failed (%d%%). The stone is spent.",
  tb_tien_xong    = "%s ascended %s.",
  no_da           = "Not enough Black Iron.",
  ...
  panel_quay      = "Fortune",
  quay_tieude     = "FORTUNE",
  quay_the_da     = "for gear later",
  quay_the_chiso  = "one random attribute",
  quay_the_vang   = "spend at the shop",
  quay_chon       = "TAKE",
  quay_con        = "%s rolls left",
  quay_het        = "No rolls. Kill elites and bosses to earn them.",
  quay_nhan       = "Took %s.",
  st_max          = "MAX",
  st_locked       = "locked",
  st_owned        = "owned",
...
T.vi = {
  ...
  boss_suffix     = "Ma Ton",
  boss_toi        = "%s da giang the.",
  boss_cuong      = "Boss PHAT CUONG!",
  boss_trieu      = "Boss goi thuoc ha.",
  boss_khien      = "Boss dung khien ho the.",
  panel_vang      = "Vang",
  panel_go        = "Go",
  panel_shop      = "Cua Hang",
  no_go           = "Khong du Go.",
  ...
  tb_chua_luyen   = "Chua luyen.",
  tb_len          = "Len %s -- %d%%",
  tb_can_tien     = "Da Hoan Hao. Tien Giai de di tiep.",
  tb_tran         = "Tu Vi chua toi %s.",
  tb_max          = "Da tien hoa tron ven.",
  tb_nut_nang     = "LUYEN",
  tb_nut_tien     = "TIEN GIAI",
  tb_thanh        = "%s luyen thanh %s.",
  tb_truot        = "Luyen that bai (%d%%). Vien da da mat.",
  tb_tien_xong    = "%s tien giai %s.",
  no_da           = "Khong du Da Huyen Thiet.",
  ...
  cur_vang        = "Vang",
  cur_da          = "Da",
  panel_da        = "Huyen Thiet",
  panel_quay      = "Co Duyen",
  quay_tieude     = "CO DUYEN",
  quay_the_da     = "de nang trang bi sau",
  quay_the_chiso  = "mot chi so ngau nhien",
  quay_the_vang   = "tieu o cua hang",
  quay_chon       = "CHON",
  quay_con        = "Con %s luot",
  quay_het        = "Het luot. Ha tinh anh va boss de co them.",
  quay_nhan       = "Da nhan %s.",
  st_max          = "TOI DA",
  st_locked       = "chua mo",
  st_owned        = "da co",
