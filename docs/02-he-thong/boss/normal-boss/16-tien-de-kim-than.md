# 16. Tiên Đế Kim Thân — *Immortal Emperor*

> **Cảnh giới 16 — Tiên Đế** *(Immortal Emperor)* · stage **80** · unit `Hblm` *(Blood Mage)*

Mở màn cõi cuối. Khiên che giai đoạn đầu, phát cuồng khoá giai đoạn cuối — trận có hai nửa rõ rệt.

## Cơ chế

| Cơ chế | Làm gì | Đánh thế nào |
|---|---|---|
| **Hào quang** `trueshot` | Trueshot Aura — **đòn tầm xa** của boss mạnh hơn. *(Warcraft: chỉ ăn với đòn **tầm xa**)* | Luôn bật, không hồi chiêu, không tắt được. Là **phần trăm** nên tự bám theo sức boss, không bao giờ teo. |
...
báo đỏ ngay nếu sai, không đợi tới cảnh giới 16 mới phát hiện.
