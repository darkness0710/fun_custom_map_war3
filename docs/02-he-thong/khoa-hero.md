...
> **Trạng thái:** Đã cài
> **Cập nhật:** 2026-09-14
> **Code:** [04_player.lua](../../src/04_player.lua)
...
|---|---|---|
| **Luôn có sẵn**, không lên cấp | Để trống `Techtree - Hero Abilities`, gọi `UnitAddAbility(u, id('A000'))` ngay sau `CreateUnit` trong [07_heropick.lua](../../src/07_heropick.lua) | Giữ nguyên hiện tại |
