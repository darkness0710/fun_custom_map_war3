...
Lúc ngồi điền chỗ trống đó thì lộ ra một câu hỏi không né được: bảy món giờ chia
...
- **Nhân phần trăm** (Kiếm → %sát thương gây ra, Khiên → %đòn đánh nhận vào,
  Nhẫn → %phép nhận vào): nhân vào một con số khác.
...
**Cho cả bảy món cùng một đường cong lũy thừa.** Đơn giản hơn để viết, và là thứ
...
`onDamaged`. Bỏ vì khi đó bảy món chỉ còn **ba** vai thật — Kiếm và Áo sẽ là
cùng một thứ, vì Str cho cả sát thương lẫn máu. Bảy món mà ba vai thì sáu ô kia
chỉ là trang trí.
...
- **Thiếu `BlzGetEventDamageType` thì Nhẫn không ăn gì.** Bản 1.31.1 có native
  này trong bảng thăm dò nhưng chưa xác nhận. Code ghi vết **một lần** rồi coi
  mọi đòn là vật lý, chứ không im lặng — nếu không thì "Nhẫn vô dụng" sẽ bị chẩn
  nhầm thành lỗi cân bằng.
- **Khiên và Nhẫn nhân với nhau, không cộng.** Cộng thì hai nguồn đủ mạnh sẽ chạm
