...
-- nguon: src/  |  build luc: 2026-09-19 22:38:30  |  35 file
...
if PreloadGenClear ~= nil then
  ...
  Preload("chunk BAT DAU nap -- build 2026-09-19 22:38:30")
...
T.en = {
  ...
  gate_gift        = "Starting kit: %d health potions, %d mana potions, %d watch towers, %d forge stones.",
...
T.vi = {
  ...
  gate_gift        = "Qua khoi dau: %d binh mau, %d binh mana, %d thap canh, %d da ren.",
