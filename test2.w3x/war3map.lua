...
-- nguon: src/  |  build luc: 2026-09-19 17:11:05  |  34 file
...
if PreloadGenClear ~= nil then
  ...
  Preload("chunk BAT DAU nap -- build 2026-09-19 17:11:05")
...
T.en = {
  ...
  wave_mod        = "Trait: %s",
  cheat_seen      = "was caught using a Warcraft cheat.",
  relic_need      = "DEFEAT %s",
...
T.vi = {
  ...
  wave_mod        = "Tu chinh: %s",
  cheat_seen      = "bi bat dung cheat cua Warcraft.",
